defmodule ProxyTest do
  ...
  test "sends a properly formatted event to Kinesis", %{state: state} do
    ...
    event =
      ~s([{"data":{"raw":"4994,TSCH,02:00:06,R,RLD,W"},"id":"myH7tTFo1tuZdSXxQ/5QFA4Xx58=","type":"com.mbta.ocs.raw_message","time":"2021-08-13T12:00:00Z","source":"#{:inet.gethostname() |> elem(1)}.mbta.com/trike","specversion":"1.0","partitionkey":"test_key","sourceip":""}])
  ...
  test "combines multiple OCS records into a single Kinesis batched record", %{state: state} do
    ...
    event =
      ~s([{"data":{"raw":"4994,TSCH,02:00:06,R,RLD,W"},"id":"myH7tTFo1tuZdSXxQ/5QFA4Xx58=","type":"com.mbta.ocs.raw_message","time":"2021-08-13T12:00:00Z","source":"#{:inet.gethostname() |> elem(1)}.mbta.com/trike","specversion":"1.0","partitionkey":"test_key","sourceip":""},{\"data\":{\"raw\":\"4995,TSCH,03:00:06,R,RLD,W\"},\"id\":\"O7ODUPlPMM089UZL1YLYpFIZzeo=\",\"type\":\"com.mbta.ocs.raw_message\",\"time\":\"2021-08-13T12:00:00Z\",\"source\":\"#{:inet.gethostname() |> elem(1)}.mbta.com/trike\",\"specversion\":\"1.0\",\"partitionkey\":\"test_key\",\"sourceip\":\"\"}])
