defmodule CloudEventTest do
  ...
  test "creates an event from an OCS message" do
    ...
    assert CloudEvent.from_ocs_message("4994,TSCH,02:00:06,R,RLD,W", now, "1bQ0GxT4mk") == %CloudEvent{
      data: %{
        raw: "4994,TSCH,02:00:06,R,RLD,W",
        received_time: ~U[2021-08-13 12:00:00Z]
      },
      id: "MKHkLK0QpFSsMkz8MeIw1UvgnAY2iGPTCLY+U1y4M8UVHNFTz+21I6TRrllJBAmyK3Jn3K8kwVxL3owWUFJX2g==",
      partitionkey: "1bQ0GxT4mk",
      source: %URI{
        authority: "opstech3.mbta.com",
        fragment: nil,
        host: "opstech3.mbta.com",
        path: "/trike",
        port: nil,
        query: nil,
        scheme: "ocs",
