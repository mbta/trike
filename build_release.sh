...
# Run this from the repo root directory (i.e. /c/Users/RTRUser/GitHub/trike_release_prod)
# Takes the release node name as an argument (e.g. `$ ./build_release.sh trike`)
